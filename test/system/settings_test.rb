...
class SettingsTest < ApplicationSystemTestCase
  ...
  test "creating a Setting" do
    ...
    fill_in "Ftp password", with: @setting.ftp_password
    fill_in "Ftp port", with: @setting.ftp_port
    fill_in "Ftp server", with: @setting.ftp_server
    fill_in "Instance name", with: @setting.instance_name
